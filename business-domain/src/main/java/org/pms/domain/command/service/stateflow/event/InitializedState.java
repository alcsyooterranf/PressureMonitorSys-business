...
//        boolean isSuccess = commandRepository.alterStatus(taskId, currentState, CommandState.SENT);
//        return isSuccess ?
...
//        boolean isSuccess = commandRepository.alterStatus(taskId, currentState, CommandState.DELIVERED);
//        return isSuccess ?
//                HttpResponse.<String>builder()
//                        .code(ResponseCode.COMMAND_STATE_ALTER_SUCCESS.getCode())
//                        .message(ResponseCode.COMMAND_STATE_ALTER_SUCCESS.getMessage())
...
//        boolean isSuccess = commandRepository.alterStatus(taskId, currentState, CommandState.CANCELLED);
//        return isSuccess ?
//                HttpResponse.<String>builder()
//                        .code(ResponseCode.COMMAND_STATE_ALTER_SUCCESS.getCode())
//                        .message(ResponseCode.COMMAND_STATE_ALTER_SUCCESS.getMessage())
