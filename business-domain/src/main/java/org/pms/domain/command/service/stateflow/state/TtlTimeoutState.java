...
public class TtlTimeoutState extends AbstractState {
	...
	public void ttlTimeout(Long aepTaskId, Long deviceId, CommandExecutionStatusVO currentState) {
		// TTL_TIMEOUT -> TTL_TIMEOUT (不允许，终态)
