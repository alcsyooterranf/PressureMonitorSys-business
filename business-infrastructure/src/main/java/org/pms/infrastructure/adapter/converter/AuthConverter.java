...
import org.pms.domain.rbac.model.entity.RoleEntity;
...
public abstract class AuthConverter {
	...
	/**
	 * 单个JavaBean转换 CreateUserCommand -> UserPO
	 *
	 * @param command Command对象
	 * @return PO类
	 */
	public abstract UserPO createUserCommand2PO(CreateUserCommand command);

	/**
	 * 单个JavaBean转换 UpdateUserCommand -> UserPO
	 *
	 * @param command Command对象
	 * @return PO类
	 */
	@Mapping(target = "password", source = "newPassword")
	public abstract UserPO updateUserCommand2PO(UpdateUserCommand command);

	/**
	 * 单个JavaBean转换 UserCreateReq -> UserPO
	 * @deprecated 使用createUserCommand2PO替代
	 *
	 ...
	 * @deprecated 使用updateUserCommand2PO替代
	 *
