...
@RestController
@RequestMapping("/user/")
public class UserManageController implements IUserManagerFacade {
	...
	@RequestMapping(value = "query_user_by_conditions", method = RequestMethod.POST)
	...
	@RequestMapping(value = "query_role_by_conditions", method = RequestMethod.POST)
